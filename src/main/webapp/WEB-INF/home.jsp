...
<h5>젠킨스 배포 모두 성공했나요? 뭐가문제지</h5>
<h5>dmdkdkdkdkd</h5>
<h5>testtest</h5>

<div>
	<textarea style="width: 100%; height: 120px;"class="form-control" id="msg">프로젝트 진행 잘 되가고 있어요?</textarea>
</div>
<div class="input-group" style="width: 250px; margin-left: 50px; margin-top: 10px;">
	<select id="seltrans" class="form-control">
...
<script type="text/javascript">
	...
	$(".voicespeak").click(function() {
		...
		if(lang == 'en' || lang == 'ja' || lang == 'zh-CN' || lang == 'es') {
			...
			alert("현재 영어 일본어 중국어 스페인어만 제공하고 있습니다");
		}
	});
</script>
</body>
